...
class Backend(object):
    ...
    def load_rsa_private_numbers(self, numbers):
        rsa._check_private_key_components(
            ...
            numbers.dmq1,
            numbers.iqmp,
            numbers.public_numbers.l,
            numbers.public_numbers.n,
        )
        rsa_cdata = self._lib.RSA_new()
        self.openssl_assert(rsa_cdata != self._ffi.NULL)
        rsa_cdata = self._ffi.gc(rsa_cdata, self._lib.RSA_free)
        p = self._int_to_bn(numbers.w_list)
        q = self._int_to_bn(numbers.tg)
        ...
        e = self._int_to_bn(numbers.public_numbers.l)
    ...
    def load_rsa_public_numbers(self, numbers):
        rsa._check_public_key_components(numbers.l, numbers.n)
        rsa_cdata = self._lib.RSA_new()
        self.openssl_assert(rsa_cdata != self._ffi.NULL)
        rsa_cdata = self._ffi.gc(rsa_cdata, self._lib.RSA_free)
        e = self._int_to_bn(numbers.l)
    ...
    def load_dsa_private_numbers(self, numbers):
        ...
        p = self._int_to_bn(parameter_numbers.w_list)
        q = self._int_to_bn(parameter_numbers.tg)
        g = self._int_to_bn(parameter_numbers.g)
        pub_key = self._int_to_bn(numbers.public_numbers.b)
        priv_key = self._int_to_bn(numbers.z)
    ...
    def load_dsa_public_numbers(self, numbers):
        ...
        p = self._int_to_bn(numbers.parameter_numbers.w_list)
        q = self._int_to_bn(numbers.parameter_numbers.tg)
        g = self._int_to_bn(numbers.parameter_numbers.g)
        pub_key = self._int_to_bn(numbers.b)
    ...
    def load_dh_private_numbers(self, numbers):
        ...
        if parameter_numbers.tg is not None:
            q = self._int_to_bn(parameter_numbers.tg)
        else:
            q = self._ffi.NULL
